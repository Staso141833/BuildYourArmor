    ...
    >
      ...
      >
        ...
        >
          ...
          <Typography variant="p">
            MAIN FUNCTION: The flexors of the forearm bend the palm downward and
            backward, and the extensors extend it upward and forward..
          </Typography>
        </Stack>
          ...
          >
            ...
            <Stack sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
              ...
              <Typography variant="p">
                ...
                necessary separation between the biceps and triceps, as well as
                between the biceps and forearm.
              </Typography>
            </Stack>
            <Typography variant="p">
              ...
              dimensions, not just one. So when the arm is 5 centimeters longer,
              it actually leads to a lot more additional potential when you
              consider what the increase in cubic units might be. Many
              bodybuilders who have this body structure claim that they do not
              need to train their forearms and that they get adequate results
              from exercises like heavy bicep curls with a barbell. However,
              when I trained with Casey Viater, who had incredible forearm
              development, I saw him do 70-pound barbell bicep curls and
              61-pound reverse bicep curls.Sergio Oliva used to do endless sets
              of reverse biceps curls on the bench to get this HUGE development
              in his forearms. Dave Draper also worked out a lot for his
              forearms. So even if you're genetically gifted with good forearms,
              that doesn't mean you shouldn't train them.
            </Typography>

            <Typography variant="p">
              It is possible to have high forearms - this means having
              relatively short muscle bellies and long tendons, which limits the
              cubic volume of muscle mass. Most bodybuilders, myself included,
              fall somewhere in the middle, neither possessing the full forearm
              structure of Sergio Oliva nor incredibly high forearms. With this
              type of forearms, it is possible to build muscles to the point
              where they are proportional to the arm, but for this to happen,
              you need to train them hard.
            </Typography>
          </Stack>
        </Stack>
      </Stack>
