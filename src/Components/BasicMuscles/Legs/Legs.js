        ...
        >
          ...
          >
            ...
            <Typography variant="p">
              ...
              muscles on the front outer surface of your thighs that act as leg
              extensors. The four muscles are m.rectus femoris - straight thigh
              muscle, m.vasus intermedius - broad intermediate thigh muscle
              (invisible because it is located under m.rectus femoris), m.vastus
              medialis - occupies the front-inner part of the thigh, and
              m.vastus lateralis- occupies the front-outer part of the thigh.
              joint.
            </Typography>
            <Typography variant="p">
            ...
            <Typography variant="p">
              Main function: bending at the knee joint. Other important muscles
              of the thigh include: m.tensor fasciae lattae - tensor muscle of
              the broad femoral fascia, which descends from the hip to the outer
              part of the thigh; and tailor's muscle (m.sartorius) - the longest
              muscle in the human body, which runs diagonally across the
              upper-inner thigh.
            </Typography>
          </Stack>
