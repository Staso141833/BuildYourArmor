    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <Typography variant="p">
              When you see Franco Columbo or Frank Zane doing arched back pose,
              you can't help but be impressed by the way the lower part of the
              latissimus dorsi extend to their starting point at the waist. This
              gives these muscles an incredibly aesthetic look.
            </Typography>
            <Typography variant="p">
              ...
              Barbell Pulls and Close Grip Pull Ups for example, as well as One
              Arm Pulley Pull Ups and One Arm Dumbbell Rows hand. In addition,
              it is important to perform stretching exercises between sets so
              that you feel a complete stretch in the lower part of the muscle.
            </Typography>
            <Typography variant="p">
              A well-developed lower latissimus dorsi will also help you in back
              poses, as they angle downward and form a sort of frame that
