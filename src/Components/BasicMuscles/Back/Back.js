        ...
        >
          ...
          >
            <Typography variant="p">
              ...
              from the level of your armpits down to the narrowest part of your
              back on either side. These are the largest muscles in the upper
              body.
            </Typography>
            ...
            <Typography variant="p">
              ...
              along the spine that stand out more clearly in the lumbar region.
              They protect the nerves exiting the spine and help straighten the
              back. These are the slowest recovering muscles in the human body
        ...
        >
          ...
          >
            ...
            <Typography variant="p">
              ...
              themselves. When you're in Double Biceps Back Pose, the trapezius
              and upper and middle back muscles are dominant, but all the
              muscles from elbow to elbow have a role to play, including the
              biceps and rear deltoids.
            </Typography>
            <Typography variant="p">
              The central muscle in the upper back is the trapezius, an angular
              muscle that extends down from the shoulders on either side of the
              neck, then meets at a point on the spine, roughly mid-back. With a
              highly developed back, the trapezius muscles will be large and
              massive, balancing the broad back muscles on each side, and
              clearly separated from them in the back poses. The exercises that
              train especially the trapezius muscles, cover everything, at which
              is included lifting the shoulders - in the first place Trapezoid
              shrugs and Standing Barbell Rows, but also Rowing in some poses
              and some types of push-ups. They are discussed in the training
              program for training the trapezius muscles.
            </Typography>
          </Stack>
          ...
          >
            ...
            <Typography variant="p">
              In the arched back pose, you need a solid, muscular upper back to
              balance the development of the shoulders, biceps, triceps and
              forearms.
            </Typography>
          </Stack>
        </Stack>
          ...
          >
            ...
            >
              <Typography variant="p">
                ...
                pose, you can't help but be impressed by the way the lower part
                of the latissimus dorsi extend to their starting point at the
                waist. This gives these muscles an incredibly aesthetic look.
              </Typography>
              <Typography variant="p">
                In order to develop the lower part of these muscles, you should
                perform your back exercises with a lot of weight - Close Grip
                Barbell Pulls and Close Grip Pull Ups for example, as well as
                One Arm Pulley Pull Ups and One Arm Dumbbell Rows hand. In
                addition, it is important to perform stretching exercises
                between sets so that you feel a complete stretch in the lower
                part of the muscle.
              </Typography>
              <Typography variant="p">
                A well-developed lower latissimus dorsi will also help you in
                back poses, as they angle downward and form a sort of frame that
                reveals a well-toned lower back.
              </Typography>
            </Stack>
          </Stack>
        </Stack>
        ...
        >
          ...
          >
            ...
            <Typography variant="p">
              ...
              predisposition: the density and musculature of his back shows how
              hard he has trained to realize his potential.
            </Typography>
          </Stack>
        </Stack>
        ...
        >
          ...
          >
            <Typography variant="p">
              ...
              swinging movement, instead of letting the latissimus dorsi do the
              bulk of the work. You should make an effort when training the
              latissimus dorsi to isolate them so that only they participate in
              the movement.
            </Typography>
            <Typography variant="p">
              The muscles in the lower back function differently than other
              muscles in the body. They are stabilizers that keep the body
              stable rather than contracting and relaxing along an arc of motion
              like say the biceps. Therefore, when you perform full range of
              motion exercises such as Hyperextensions or Deadlifts with
              extended legs, you are putting such a strain on your low back that
              it may take you a week or so to fully recover. Tova oznachava, che
              trenirovkata na poyasnata oblast chrez usiliya, koito vklyuchvat
              tsyaloto tyalo, pri izpolzvaneto na uprazhneniya za sila s
              maksimalna tezhest, e neobkhodima samo po vednŭzh v sedmitsata. V
              ostanalite dni izpŭlnyavaĭte seriite si s nesilovi uprazhneniya i
              s po-malka ot maksimalnata tezhest. This means that training the
              lumbar region through efforts that involve the whole body, using
              maximum weight strength exercises, is only necessary once a week.
              On the other days, perform your sets with non-strength exercises
              and with less than maximum weight.
            </Typography>
          </Stack>
        </Stack>
      </Stack>
