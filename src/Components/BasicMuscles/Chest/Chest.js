          ...
          >
            ...
            >
              ...
              <Typography variant="p">
                ...
                qualities for any bodybuilder. To achieve this, training with
                different types of exercises is required - to develop the upper
                and middle-lower part of the pectoral muscles, their inner and
                outer parts, as well as to form the transition to the deltoid
              ...
              <Typography variant="p">
                ...
                <List>
                  ...
                  <ListItem>
                    <ListItemText primary="2. Thick chest muscles" />
                  </ListItem>
                  <ListItem>
                    <ListItemText primary="3. Development of the inner, outer, upper and middle-lower pectoral muscles" />
                  </ListItem>
                  <ListItem>
                    <ListItemText
                      primary="4. Visible striations when the pectoral muscles are tense, such as during the most
                       muscular pose, with striations visible from the middle of the chest, across, and along the entire length from top to bottom."
                    />
                  </ListItem>
                  <ListItem>
                    <ListItemText
                      primary="5. 
                      Clear separation between top and middle bottom."
                    />
                  </ListItem>
                  <ListItem>
                    <ListItemText
                      primary="6. 
                      A shape that gives a nice square look, achieved by significant development of
                  ...
                  <ListItem>
                    <ListItemText
                      primary="7. 
                      Sufficient development so that the pectoral muscles do not completely disappear when you raise your arms overhead or when you perform the Double Biceps Front Pose.
                      The chest workout program included here is specifically designed to help you achieve the full chest development we just described. Of course, some bodybuilders are extremely lucky because
                      of the genetic potential for breast development that they have."
                    />
                  </ListItem>
                </List>
              </Typography>
                ...
                <Stack>
                  ...
                  <Card position="relative" sx={{ width: "100%", mt: 2 }}>
                    <CardMedia
                      ...
                      component="img"
                      alt="chest musscle"
                      image="https://i0.wp.com/www.thebarbell.com/wp-content/uploads/2019/11/Franco-Columbu.jpg?resize=1068%2C936&ssl=1"
                    ></CardMedia>
                  </Card>
                </Stack>
                ...
                <Stack>
                  ...
                  <Card position="relative" sx={{ width: "100%", mt: 2 }}>
                    <CardMedia
                      ...
                      component="img"
                      alt="chest musscle"
                      image="https://fitnessvolt.com/wp-content/uploads/2017/05/arnold-chest-master.jpg"
                    ></CardMedia>
                  </Card>
                </Stack>
                ...
                <Stack>
                  ...
                  <Card position="relative" sx={{ width: "100%", mt: 2 }}>
                    <CardMedia
                      ...
                      component="img"
                      alt="chest musscle"
                      image="https://i.pinimg.com/originals/ea/c1/64/eac164e544fdd280b05792a87eba1ca9.jpg"
                    ></CardMedia>
                  </Card>
                </Stack>
              </Stack>
